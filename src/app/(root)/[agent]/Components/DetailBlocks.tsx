        ...
        >
          ...
          <div className="mt-16 mb-8">
            <h2 className="text-3xl font-bold text-white">
              <span className="text-white">{data.name}, {data.role}</span> 
            </h2>
          </div>
          <div className="relative backdrop-blur-[20px] rounded-2xl bg-white/10 p-6 max-w-[80%]">
            ...
            <div className="space-y-2">
              ...
              <p className="text-white text-sm leading-relaxed">
                "This contract outlines the terms of our agreement. It includes the scope of products/services, 
                pricing, delivery timelines, and the mutual responsibilities involved."
              </p>
            </div>
          </div>
          <img 
